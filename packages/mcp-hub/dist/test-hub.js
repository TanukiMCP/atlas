...
exports.testMCPHub = testMCPHub;
exports.testTransportValidation = testTransportValidation;
const index_1 = require("./index");
async function testMCPHub() {
    console.log('🚀 Testing MCP Client Hub...');
    // Create hub instance
    const hub = new index_1.MCPClientHub();
    try {
        // Initialize the hub
        await hub.initialize();
        console.log('✅ Hub initialized successfully');
        // Test adding a stdio server configuration
        const fileSystemConfig = (0, index_1.createStdioServerConfig)({
            id: 'test-filesystem',
        ...
        const webConfig = (0, index_1.createSSEServerConfig)({
            id: 'test-web',
        ...
        const gitConfig = index_1.commonServerConfigs.git();
        console.log('🗂️ Created Git server config:', gitConfig.name);
        const dbConfig = index_1.commonServerConfigs.database({
