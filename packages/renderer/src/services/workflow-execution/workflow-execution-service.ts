...
export class WorkflowExecutionService {
  ...
  private events: WorkflowExecutionEvents;
  private activeExecutions: Map<string, WorkflowExecution> = new Map();
  private toolRouter: any; // Reference to tool router for executing tools
   ...
   */
  private prepareStepInputs(inputs: string[], context: Record<string, any>): any {
