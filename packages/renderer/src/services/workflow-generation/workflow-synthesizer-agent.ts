...
export class WorkflowSynthesizerAgent extends BaseLLMAgent {
  constructor() {
   ...
   */
  async synthesizeWorkflow(request: WorkflowSynthesisRequest): Promise<WorkflowSynthesisResponse> {
   ...
   */
  private formatSynthesisRequest(request: WorkflowSynthesisRequest): string {
...
Please provide your analysis in the specified JSON format.`;
   ...
   */
  private parseSynthesisResponse(response: LLMResponse): WorkflowSynthesisResponse {
    try {
   ...
   * Validate ASCII visualization format
   */
  private validateAsciiVisualization(ascii: string): boolean {
   ...
   */
  private generateSampleVisualization(): string {
    return `┌─────────────────────────────────────────┐
│           WORKFLOW START                │
│           User Request Entry             │
└─────────────┬───────────────────────────┘
...
└─────────────────────────────────────────┘`;
   ...
   */
  private generateSampleWorkflow(): Partial<WorkflowTemplate> {
    return {
