...
exports.WorkflowFinalizerAgent = void 0;
...
class WorkflowFinalizerAgent extends base_llm_agent_1.BaseLLMAgent {
    constructor() {
        const config = {
     ...
     */
    async finalizeWorkflow(request) {
        const llmRequest = {
     ...
     */
    formatFinalizationRequest(request) {
...
Please ensure the finalized workflow is 100% schema compliant and ready for immediate execution.`;
     ...
     */
    parseFinalizationResponse(response) {
        try {
            ...
            parsed.validationResults.forEach((result, index) => {
    ...
    validateResponse(content) {
        try {
            ...
            if (!jsonMatch)
                return false;
            const parsed = JSON.parse(jsonMatch[0]);
            return !!(parsed.finalizedWorkflow &&
...
exports.WorkflowFinalizerAgent = WorkflowFinalizerAgent;
//# sourceMappingURL=workflow-finalizer-agent.js.map