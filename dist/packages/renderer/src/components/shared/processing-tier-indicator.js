    ...
    return (<div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          {actualDuration && (<span>Actual: {formatDuration(actualDuration)}</span>)}
        </div>
      </div>

      {/* Tier Selection */}
      {onTierSwitch && (<div style={{ padding: '12px' }}>
          <div style={{
                fontSize: '12px',
                color: 'var(--color-text-secondary)',
                marginBottom: '8px'
          ...
          <div style={{
            ...
            {allTiers.map(tier => {
                ...
                return (<button key={tier} onClick={() => onTierSwitch(tier)} style={{
                        padding: '8px',
