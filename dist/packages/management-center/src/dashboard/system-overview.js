...
const SystemOverview = () => {
    ...
    return (<div className="system-overview p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {metrics.map((metric, index) => (<div key={index} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-center justify-between">
              <div>
            ...
            <div className={`mt-2 w-2 h-2 rounded-full ${metric.status === 'good' ? 'bg-green-500' : 'bg-red-500'}`}/>
          </div>))}
      </div>
