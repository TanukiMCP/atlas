        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea className="w-full px-3 py-2 border border-gray-300 rounded-lg" rows={4} placeholder="Enter test parameters as JSON..."/>
            </div>
            
            <div className="flex space-x-3">
              <button onClick={() => onTest(tool)} className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
                Run Test
              </button>
