...
class ConflictResolver extends eventemitter3_1.EventEmitter {
    resolutionRules = [];
    ...
    preferExternalResolution(tools) {
    ...
    performanceBasedResolution(tools) {
    ...
    calculatePerformanceScore(tool) {
        let score = 0;
